...
namespace exercicio1
{
    class Program
    {
        ...
        {
            int a;
            if (!File.Exists(@"C:\Users\Exercio2.txt"))
            {
                a = 0;
            }
            else
        ...
        {
            string linha = "";
            StreamReader rd = new StreamReader(@"C:\Users\Exercio2.txt", true);
        ...
        {
            StreamWriter wr = new StreamWriter(@"C:\Users\Exercicio1.txt", true);
            wr.WriteLine(res);
            wr.Close();
            c();
            menu();
